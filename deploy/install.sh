...
#python manage.py makemigrations && python manage.py migrate && python manage.py shell --command='from core.tests import *' && python manage.py shell --command='from core.utils import *'
